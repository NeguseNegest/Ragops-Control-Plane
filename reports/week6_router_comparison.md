...
Evaluation: `router_comparison@0.2.0` (evaluated)
Router: `rule_router@0.2.0` (draft)
...
| Routed | 64.44% | 0.5267 | 100.00% | 84.21% | 71.93% | 3345.6 ms | 7915.5 ms | $0.00312740 |
...
- Versus Always FAST: Hit@5 +35.56%; combined proxy +49.12%; average latency +392.10%; projected total cost +114.30%.
- Versus Always CAREFUL: Hit@5 -20.00%; combined proxy +5.26%; average latency -28.54%; projected total cost -11.96%.

Decision: **keep_router_draft**. Day 42 tuning is complete; keep the policy draft until broader offline and live evidence reduces the supported false-refusal risk.
